...
namespace GamesInfrastructure.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(Istp1Context context)
        {
            _context = context;
        }
        ...
        {
            var istp1Context = _context.Reviews.Include(r => r.Game);
        ...
        public async Task<IActionResult> Create([Bind("Id,GameId,Rating,Review1")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,GameId,Rating,Review1")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
