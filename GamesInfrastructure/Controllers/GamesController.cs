...
namespace GamesInfrastructure.Controllers
{
    public class GamesController : Controller
    {
        ...
        public GamesController(Istp1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PublisherId,GenreId")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PublisherId,GenreId")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
